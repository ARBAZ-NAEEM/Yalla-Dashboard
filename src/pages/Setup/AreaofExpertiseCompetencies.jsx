...
const AreaOfExpertiesCompetencies = () => {
  const {
    SearchFields,
    FormFields,
    TableLoading,
  ...
  const columns = [
    { field: "SetupDetailName", name: "Area Of Experties/Competencies Type" },
  ];
  ...
  const searchPanel = (
    <Fragment>
      <Col lg="3" md="3" xs="12">
        <FormGroupInput
          label="Search Area Of Experties/Competencies"
  ...
  const formPanel = (
    <Fragment>
      <Col lg="6" md="6" xs="12">
        <FormGroupInput
          label="Area Of Experties/Competencies"
          name="SetupDetailName"
          maxLength="150"
          required
          isAlphabetic={true}
  ...
  return (
    <CrudFormComponent
      formName="Area Of Experties/Competencies"
      buttonName="Add"
      // hideAction={false}
...
export default AreaOfExpertiesCompetencies;
