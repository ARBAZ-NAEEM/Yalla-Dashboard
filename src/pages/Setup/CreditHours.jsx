...
const CreditHours = () => {
  ...
  const columns = [
    { field: "credithours", name: "Credit Hours" },
...
const courseslist = [
  ...
  return (
    <Container fluid>
      <Card className='mt-3'>
        <CardTitle>Search Credit Hours</CardTitle>
        <CardBody>
          <Row>
          <Col lg='3' md='3' xs='12'>
          <FormGroupSelect
      ...
      <Modal isOpen={modal} centered toggle={toggle} modalTransition={{ timeout: 10 }} data-backdrop="static" data-keyboard="false" >
        <ModalHeader toggle={toggle}>Add/Edit Credit Hours</ModalHeader>
        <ModalBody>
          <Row>
          <Col lg='6' md='6' xs='12'>
          <FormGroupSelect
