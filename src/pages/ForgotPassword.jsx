...
import { Insert } from "../common/SetupMasterEnum";
            ...
            <Card className="auth-form">
              <CardBody className="p-5 pt-3 pb-3">
                ...
                <form onSubmit={onSubmit}>
                  <h4 className="authf-title mb-2">Forgot Password</h4>
                  ...
                  <div className="text-center mt-3 mb-4">
                    <Button color="primary" className="w-50" type="submit" style={{backgroundColor:"#0f73ee", borderColor:"#0f73ee",borderRadius:"40px"}}>
                      Submit
                    </Button>
                  </div>
                </form>
                <div className="form-copyright text-center">
                <b>                  Copyright © {new Date().getFullYear()} SALU.
</b>
                </div>
              </CardBody>
            </Card>
