...
const SaveWorkPermit = forwardRef((props, ref) => {
  const { workPermitData } = props;
  console.log(workPermitData);
  console.log("VIEW, Data", workPermitData?.signature);
  return (
    <>
      <div ref={ref}>
        <table>
        ...
        <div className="table-data text-center" style={{ marginTop: "30px" }}>
          ...
          <p className="text-center">Company: S T R A B A G , View</p>
        </div>
        ...
        <div className="table-data text-center" style={{ marginTop: "60px" }}>
          <table>
            <tr>
              <td
                style={{
        ...
        <div className="table-data text-center" style={{ marginTop: "500px" }}>
          <table>
            <tr>
              <td
                style={{
          ...
          <div className="table-data" style={{ marginTop: "60px" }}>
            <h4>Isolation and Lockout Procedures</h4>
            <h5>Details of equipment or systems to be isolated:</h5>
            <p>
              Identify the specific equipment or systems that need to be
              isolated for the safe execution of [Type of Work].
            </p>
            <h5>Lockout/tag-out procedures:</h5>
            <p>
              [Provide detailed steps for the proper lockout/tag-out procedures
              to ensure the isolation of energy sources during [Type of Work].]
            </p>
            ...
            <p>
              ...
              [Type of Work], including who to contact and how to convey
              critical information.]
            </p>
            <h4>Permit Conditions</h4>
            <h5>Compliance with all safety regulations and procedures:</h5>
            <p>
              [Emphasize the importance of all personnel adhering to [Your
              Company Name]'s safety regulations and procedures during [Type of
              Work].]
            </p>
            <h4>Adherence to the specified work hours:</h4>
            <p>
              [Specify the authorized work hours for [Type of Work] and stress
              the importance of adhering to the designated timeframe.]
            </p>
            ...
            <h5>
              The permit is valid only for the specified date and time
              mentioned:
            </h5>
            <p>
            ...
            <p>
              ...
              the collective responsibility of all employees, subcontractors,
              and visitors to the jobsite. It is the policy of [Your Company
              Name] to provide prompt medical treatment when a worker is injured
              on the jobsite. This may involve performing a working at heights
              rescue to bring down a worker who has fallen and is suspended in a
              safety harness.
            </p>
          </div>
        </div>

        <div className="table-data" style={{ marginTop: "260px" }}>
          <table>
            <tr>
              <td
                style={{
          ...
          <div className="table-data text-center" style={{ marginTop: "60px" }}>
            ...
            <p>
              When a worker falls and is suspended in a harness, it is crucial
              to execute a rescue as quickly as possible due to the following
              reasons: The worker may have sustained injuries during the fall
              and may require immediate medical attention. Prolonged suspension
              in safety harnesses may lead to blood pooling in the lower body,
            ...
            <p>
              ...
              session covering emergency response procedures, alarms, and
              assembly areas
            </p>
            <p>
            ...
            <p>
              Stop all work in the immediate vicinity, evaluate the situation,
              and identify further hazards.
            </p>
            <p>
            ...
            <h5>
              ...
              method and (B) as an alternative when no other means are
              available.
            </h5>
            ...
            <p>
              Ensure compliance with jobsite-specific rescue and evacuation
              plans.
            </p>
          ...
          >
            <tr>
              ...
              >
                ...
                <div className="signature-image">
                  <img
                    className="thirsd-image"
                    src={workPermitData?.pdf_safety}
                    alt="Safety Signature"
                  />
                </div>
              </td>
            </tr>
