...
const CreditNote = () => {
  ...
  const submitForm = (e) => {
    e.preventDefault();
    if (calculateSum("DebitSum") === calculateSum("GrandSum")) {
      const detailArray = inputList?.map((x) => ({
        ...
        refDate: moment(new Date(tbL_TYPE_VOUCHERMASTER_?.refDate)).format(
          "YYYY-MM-DD"
        ),
      }));
      const lastRowofTable = {
        ...
        debit: 0,
        credit: calculateSum(),
        refJournal: lastRow?.refJournal,
        refJournallNo: lastRow?.refJournallNo,
                      ...
                      <tbody>
                        <tr style={{ backgroundColor: "rgb(230 231 153)" }}>
                          ...
                          <td
                            ...
                            className="text-center"
                          >
                            {parseFloat(calculateSum("GrandSum")).toFixed(2)}
                          </td>
                          <td
                            style={{ width: "10%" }}
                            className="text-center"
